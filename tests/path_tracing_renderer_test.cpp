...
int main()
{
    ...
    renderer::PathTracingRenderer renderer(256, 256);
    ...
    renderer.setDirectionalLight(
        glm::normalize(glm::vec3{-0.5f, -1.0f, -0.3f}), glm::vec3{0.04f}, glm::vec3{0.9f}, glm::vec3{1.0f});
    ...
    std::cout << "Path tracing renderer produced a CPU frame image.\n";
    return 0;
}
