...
void TestAppLayer::onRender()
{
    ...
    debugRenderer.drawLine(glm::vec3{-0.8f, -0.8f, 0.0f}, glm::vec3{0.8f, 0.8f, 0.0f}, glm::vec3{1.0f, 0.0f, 0.0f});
    debugRenderer.drawLine(glm::vec3{-0.8f, 0.8f, 0.0f}, glm::vec3{0.8f, -0.8f, 0.0f}, glm::vec3{0.0f, 0.8f, 1.0f});
}
} // namespace lunalite::test_app
